jQuery(document).ready(function ( $ ) {
    ...
    $(document).on("focus", "#billToEditable" , function(){
     ...
     // SALE ALERT: Notification cookie			
     $('#march2021SaleAlert .close').click(function( e ){			
       e.preventDefault();			
       Cookies.set('march2021SaleAlert', 'closed', { expires: 30 });			
     });			

     if(Cookies.get('march2021SaleAlert') !== 'closed') {			
       $('#march2021SaleAlert').removeClass('d-none');			
     }
